...
switch (ansver(works.a00, works.a1, works.a2)) {
    case 1: // Первое действие - если в первом окне ввели 1 то открываем серию окон - окно 2
        switch (ansver(works.b00, works.b1, works.b2)) {
            case 1: // Второе действие, если во 2-м окне ввели 1, то переходим на 4-е окно
        ...
        break;
    case 2: //Первое действие. Если в 1-м окне ввели 2 то переходим к 3 окну
        switch (ansver(works.c00, works.c1, works.c2)) {
            case 1: // Второе действие, если во 2-м окне ввели 1 то переходим на 4-е окно
            case 2: // Если ввели 2, то также переходим на 4-е окно
                ansver(works.d00, works.d1, works.d2);
                break;
            case -1: //Второе действие
                break;
...
alert('Спасибо за игру!')ж
console.log(record);
var step = +prompt("Введите номер хода");
console.log(step);
var stepHistory = "В ходе № " + step + " " + record[step - 1][0] + "Ваш выбор " +
    alert(stepHistory);